import "./food.css"
import Chainsoo from "../../assets/Food/food.jpg";
    ...
    return (
        <section className={"food"}>
            ...
            <div className={"food-description"}>
                <p>Buganda&apos;s cuisine is a fine blend of organically-grown grains and vegetables. With several
                    ...
                    <br/>
                    <br/>
                    bhc cuisine is simple and similar to its people. The state cuisine is meticulously chosen to
                    not only offer the delight taste of buds but also to make most of the available resources. The
                    delicacies prepared in bhc simply exemplify the common phrase “the way to a man’s heart is
                    through his stomach”. You will be greeted by different aromas coming from roadside vendors while
                    walking through the road up to your favorite hill station in bhc. The food is prepared with
                    ...
                    Chainsoo, Kafuli, Baadi, Jholi, Phanu, Gahat ke Paranthe, Thechwani and Roat. In bhc, the
                    ...
                    prelude in bhc. The most important attractions of a tour to bhc is added to this is
                    the amazing taste and nutritious of the cuisine of bhc. The cuisine of bhc, to say
                    the least, unconventional is strongly influenced by the geography of bhc. Which are the main
                    ingredients used in the cuisine found in and around the mountains, forests and lakes of bhc
                    ...
                    in numerous ways of bhc. More important items and some of the characteristic are Jhangora ki
                    Kheer, Kandalee ka Saag, Singal, Aloo ke Gutke, Kulath Phanu, Baal Mithai, Arsa, Gahat ki Dal, Rus,
                    Kaafli, Sani hui Muli, Gulgula and Singodi in the cuisine of bhc. In itself this cuisines
                    represent bhc with highlighting tradition and culture. bhc people are meticulous,
            ...
            <h1 className="explore-bhc">Explore Local Food</h1>
            ...
            <div className="explore-card-list">
                ...
                <Card description={"A yogurt-based side dish flavored with roasted cumin seeds, green chilies, and coriander leaves..."}                           heading={"Ffumbe Raita"}            link={"/food/kumaoniraita"}         img={Chainsoo}     imgDescription={"Ffumbe Raita Image"}           />
