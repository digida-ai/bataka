...
function Dance() {
    return (
        <div className={"dance-container"}>
            ...
            <h1 className="explore-bhc-title">Explore bhc Dance</h1>
            <div className={"dance-list"}>
                ...
                <Card heading={"Choliya"} description={"Also known as Chhaliya or Hudkeli, is a sword dance typically showcased during weddings and other festive gatherings."} link={"choliya"} img={"https://kafaltree.com/wp-content/uploads/2021/05/Choliya-bhc-Folk-Dance-1280x720.jpg"} imgDescription={"Choliya Image"}/>
