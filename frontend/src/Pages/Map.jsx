...
import map from "../assets/App/omutaka.jpg";
import "./map.css";
...
const Map = () => {
    ...
    return (
        <div>
            <div className={"bhc-map"}>
                <h1 className={"bhc-map-heading"}>Map of bhc</h1>
                <p>Detailed map of bhc</p>
                <div ref={mapBoxHeightRef} className={"bhc-map-container"}
                ...
                >
                        <img className={"map-image"} ref={mapImageRef} src={map} alt="Important Map of bhc"
                         decoding="async"/>
                    {/*<SVGComponent />*/}
                </div>
