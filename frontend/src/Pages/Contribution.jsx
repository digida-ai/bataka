        ...
        <section className={"contribution"}>
            ...
            <div className={"contribution-container"}>
                ...
                <p>You can be a valuable part of our mission to showcase the rich culture, history, and nature of
                    bhc. We welcome contributions in both code and non-code forms:</p>
                ...
                <ul>
                    ...
                    <li><strong>Content Gathering:</strong> Select a feature or aspect of bhc and start
                ...
                <ul>
                    <li>
                        <p><strong>Suggest a Name</strong>: We are in search of a unique and concise name for our
                            website that
                            reflects its purpose. We encourage you to suggest a name in bhci clan that is
                            both
                            ...
                            choose the most fitting name. Please share your name suggestions via <a
                                ...
                                href="mailto:dgidanlpai@gmail.com">E-mail</a> 📨  </p>
                    </li>
                </ul>
            ...
            <div className={""} style={check}>
                ...
                <p>Mean while checkout <Link
                    to={"https://github.com/dgidanlpai/bhc-Culture-Preservation-Project/blob/main/contributing.md"}
