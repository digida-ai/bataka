    ...
    return (
        <section className={"contributors-container"}>
            ...
            <div className={"contributors-container-heading"}>
                <h1>Bataka Heritage</h1>
                <p>The objective of this project is to address the concerning trend of the younger generation losing
                    touch with their cultural roots and to safeguard the traditions and unique practices
                    of buganda. We believe it&apos;s crucial to bridge this gap and ensure the preservation of our
