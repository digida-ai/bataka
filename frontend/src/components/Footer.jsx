...
function Footer() {
    ...
    return (
        <footer>
            ...
            <div className={"footer-section"}>
                <div className={"footer-content"}>
                    ...
                    <div className={"footer-icon-list"}>
                        <Link to={"https://github.com/dgidanlpai/bhc-Culture-Preservation-Project"}><img
                        ...
                        <Link to={"https://www.linkedin.com/in/dgidanlpai/"}><img alt="svgImg" className={"footer-icon"}
                        ...
                        <Link to={"https://twitter.com/dgidanlpai"}><img alt="svgImg" className={"footer-icon"}
                                                                         loading="lazy" decoding="async"
                ...
                <div className={"footer-content footer-content-links"}>
                    <p>Explore the Heritage</p>
                    <ul>
                    <li><Link to={"/clan"}><img loading="lazy" decoding="async"
                                                        ...
                                                        className={"Chevron"}/>Clan</Link>
                        </li>
                        <li><Link to={"/food"}><img loading="lazy" decoding="async"
                                                    src="data:image/svg+xml;base64,"
                                                    alt="Chevron forward icon" className={"Chevron"}/>Food</Link>
                        </li>
                        <li><Link to={"/site"}><img loading="lazy" decoding="async"
                                                      src="data:image/svg+xml;base64,"
                                                      alt="Chevron forward icon" className={"Chevron"}/>Site</Link>
                        </li>
            ...
            {/*        src="https://cdnjs.buymeacoffee.com/1.0.0/widget.prod.min.js" data-id=""*/}
            ...
            <div className={"foot-note"}>
                <p>Developed with ❤️ by dgidanlpai</p>
                <p>©️ {(new Date().getFullYear())} Bataka Heritage Center</p>
            </div>
        </footer>
    );
}
